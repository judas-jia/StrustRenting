...
<header>
 <div>
	...
	<div id="leftline">
		<div class="lefthead">
		<p style="text-align:center; color:#FFFFFF; line-height:40px">订单管理中心</p>
		</div>
	...
	<div id="midhead">
		<span style=" font-size:16px; line-height:43px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我的短租<b> > </b>入住订单管理</span>
	</div>
	<div id="midtext">
	<span style="font-size:18px; color:#ccc">入住订单管理</span>
		<%
		String houseinformation = (String)request.getSession().getAttribute("usersOrdersInformation");
		...
		for (int i = 0; i < jsonArray.length(); i ++) {
			...
			<div style="width:100%; height:120px; border-bottom:1px solid #ccc;  border-top:1px solid #ccc;  position:relative;">
				<img src="images/order1.jpg" style="height:90%; width:20%; position:absolute;left:0px;top:5%;border:1px solid #ccc;  ">
			...
			<div style="width:80%; height:70%; position:absolute; bottom:5%;">
				<span style="font-size:15px">地址：<%=obj.getString("house_address") %></span><br/><br/>
				<span style="font-size:15px">房东联系方式：<%=obj.getString("mobile") %></span>
			...
			<form style="position:absolute; right:0;width:15%; height:100%; top:0;" action = "/StrustRenting/manageUersOrdersAction.action?id=<%=obj.getLong("order_id")%>" method = "post">
						<br/><br/>
					<input type="submit" value="取消订单" name = "manage" style="background-color:#FFF;color:#6699FF;border:0; position:absolute; left:10px">
					<br/>
...
<%	}
	//	System.out.println ("nnnnnnn" + json);
		%>
