...
<script type="text/javascript">
  ...
  function startCount() {
    ...
    setTimeout("startCount()",1000);
		...
		num=0;
		window.open('loadedindex.jsp','_self','width=600,height=400,top=200,left=0,menubar=no,toolbar=no,status=no,scrollbars=yes');
		}
  }
  setTimeout("startCount()",1000);
</script>
...
<p style="color:#FFFFFF; position:absolute; top:120px; left:400px; font-size:20px;">房屋发布成功！</p>
<form>
